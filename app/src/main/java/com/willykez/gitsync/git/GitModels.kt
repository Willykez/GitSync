...
/** One line-match from GitEngine.searchWorkingTree(). */
data class SearchMatch(
    val path: String,
    val lineNumber: Int, // 1-indexed
    val lineText: String, // trimmed + truncated for display
    val matchStart: Int, // index into the (untrimmed) original line — approximate after trim, used for highlight positioning
)
